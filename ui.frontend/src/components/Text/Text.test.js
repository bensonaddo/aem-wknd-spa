...
describe('Text ->', () => {
  ...
  xit('should render the text component with no parameter', () => {
  ...
  xit('should render the text component that contains the provided text as a string', () => {
    expect(rootNode.childElementCount).toEqual(0);
  ...
  xit('should render the text component that contains the provided text as a DOM structure', () => {
    expect(rootNode.childElementCount).toEqual(0);
  ...
  xit('should render the text as a rich text component', () => {
    expect(rootNode.childElementCount).toEqual(0);
  ...
  xit('should render the text as a rich text component with a given id', () => {
    expect(rootNode.childElementCount).toEqual(0);
